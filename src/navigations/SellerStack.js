...
import SellerSetObjectiveScreen from "../screens/seller/SellerSetObjectiveScreen";
...
const SellerStack = ({}) => (
  <Stack.Navigator screenOptions={{ headerShown: false }}>
    ...
    <Stack.Screen name="SellerFailedOrders" component={SellerFailedOrdersScreen} />
    <Stack.Screen name="SellerSetObjective" component={SellerSetObjectiveScreen} />
  </Stack.Navigator>
);
